...
////    int enemyX[], enemyY[];     // x and y of the player in the 2D array
//    int enemyMax = 12, enemyCount = 0;  // used in terminate function, when an enemy gets erased by a laser remember to decrease enemyMax
//    
//    // shield data
//    char shield4 = '4';
//    char shield3 = '3';
...
//    void ShiftRowsL();
//    void ShiftRowsD();
////    void Terminate();  // delete enemies after shifting them
////    void Reset();  // reset the X and Y to 0,0 when at the bottom corner of enemies
//};
//
...
////       enemyCount = 0;
////    }
////    if (((board[enemyX+1][enemyY]) && (board[enemyX+1][enemyY+1])) == emptyChar && (board[enemyX][enemyY+1]) == '#') {
////        Reset();
////    }else if (((board[enemyX+1][enemyY]) && (board[enemyX+1][enemyY-1])) == emptyChar && (board[enemyX][enemyY-1]) == '#') {
////        Reset();
////    }
...
////        }
////    }
////    if (board[enemyX][enemyY] = enemyChar){
////    board[enemyX][enemyY] = emptyChar;
////    board[enemyX][enemyY+1] = enemyChar;
////    enemyY++;
////    enemyCount++;
////    }
////    else if  ((board[enemyX][enemyY+1] && board[enemyX][enemyY+2]) ==  emptyChar) {
////        Reset();
////    }
////    if (enemyCount > enemyMax) {
////       Terminate();
...
////    int temp = enemyY;
////    if ((enemyCount > enemyMax) && (count % 2 == 0)) {
////        enemyY = 1;
////        if (board[enemyX][enemyY] == emptyChar) {
////            enemyY++;
////        } else if (board[enemyX][enemyY] == enemyChar) {
////            board[enemyX][enemyY] = emptyChar;
////            enemyCount--;
////        }else
////            board[enemyX][enemyY] = '?';
////    } else if ((enemyCount > enemyMax) && (count % 2 != 0)) {
////        enemyY = col-2;
////        if (board[enemyX][enemyY] == emptyChar) {
////            enemyY--;
////        } else if (board[enemyX][enemyY] == enemyChar) {
